  ...
  return (
    <Legal name="Privacy Policy">
      <div className="px-8 pb-8 pt-[100px] lg:px-0">
        ...
        <h2 className="my-5 text-lg font-bold">Scope of this Privacy Policy</h2>
        <p className="mb-5">
        ...
        <p className="mb-5">
          ...
          websites, or software, such as third-party applications that may be
          integrated into our Services via API. Those services, websites, and
          software are subject to their own terms and privacy policies, and you
          should read those carefully.
        </p>
        <h2 className="my-5 text-lg font-bold">Information We Collect</h2>
        <p className="mb-5">
        ...
        <ul>
          <li>
            <em>Account Information: </em>To create an account for the Services
            or to enable certain features, we require that you provide us with
            information for your account such as name, email, password, and
            authentication credentials. If you sign up for a paid subscription,
            we (or our payment processors) may need your billing details such as
            credit card information, banking information, and billing address.
          </li>
          <li>
            <em>Video and Other Customer Data: </em>In using our Services, our
            customers submit or upload video recordings, seek user support, or
            provide other Customer Data (defined in our Terms of Service) to us.
            Our use of and processing of Customer Data is governed by our Terms
            of Service.
          </li>
          <li>
            <em>Other Information You Provide: </em>We receive other information
            from you when you choose to interact with us in other ways, such as
            if you sign up for one of our webinars or e-books, participate in a
            research study, contest, sweepstake, or event, apply for a job, or
            otherwise communicate with us.
          </li>
        </ul>
        <p className="mb-5">Information We Collect Automatically:</p>
        <ul>
          <li>
            <em>Usage Data: </em>We automatically collect usage data about how
            you interact with our Services when you use them. For example, this
            could be actions you take on our platform, such as number of videos
            you’ve recorded or viewed, your sharing activity, or what
            third-party integrations you enabled.
          </li>
          <li>
            <em>Log Data:</em> Our servers automatically log certain types of
            data when you visit or use our Services, for example, when you
            navigate through our website. This data is stored in our log files
            and includes, Internet Protocol (IP) address, type of device,
            operating system or browser, unique device identifiers, browser
            settings, date and time you visited or used our Services, the
            referring website, URL parameters, and error and crash reporting
            data.
          </li>
          <li>
            <em>Information from Cookies and Similar Technologies: </em>A cookie
            is a small piece of information that is downloaded to your device by
            ...
            preferences, understand how you interact with our Services or emails
            that we send you, maintain the security of our Services, and
            administer, improve and promote our Services. You can configure your
        ...
        <p className="mb-5">Information We Receive from Third Parties:</p>
        <ul>
          <li>
            ...
            integration. Additionally, if you sign up or login to our Services
            using one of our single-sign-on providers (e.g., Google, Apple,
            etc.), we collect authentication information provided to us by the
            provider to allow you to log in.
          </li>
          <li>
            <em>Marketing Information: </em>We may receive marketing or
            demographic information about you from third parties or partners,
            for example, data about your organization or industry or other
            public information from sources like social media or online
            professional profiles. We may combine this information with other
            data we already have to improve your experience with our Services or
            inform you of Services we think may be of interest to you.
          </li>
        </ul>
        <h2 className="my-5 text-lg font-bold">How We Use Your Information</h2>
        <p className="mb-5">We use your information in the following ways:</p>
        <ul>
          <li>To provide and maintain our Services.</li>
          <li>To analyze and improve our Services.</li>
          <li>
            To keep our Services secure and protect against fraud, abuse, and
            intrusion.
          </li>
          <li>
            To provide user support, information, and services requested by you.
          </li>
          <li>To send important account or security notifications.</li>
          <li>
            To promote our Services in accordance with applicable laws and
            regulations. If you’d like to unsubscribe from our marketing emails,
            click the “unsubscribe” link at the bottom of the email. You can
            also update your notification preferences in your account settings.
          </li>
          <li>
            To comply with our legal obligations, including responding to a
            court order or other valid legal process.
          </li>
          <li>For other purposes with your consent.</li>
        </ul>
        <p className="mb-5">
          Please keep in mind that customers control their accounts and
          associated Customer Data. We use Customer Data according to our
          customers’ instructions and our Terms of Service. Customers are able
          to: (1) restrict, remove, disclose, and access content and information
        ...
        <p className="mb-5">
          ...
          be reasonably associated with an identifiable person, we may use it
        ...
        <ul>
          <li>
            <em>Trusted Third Parties: </em>We disclose information to our
            service providers or other third-parties so they can help us provide
            our Services and run our business. Examples include for storing
            Customer Data, payment processing, providing customer service, and
            helping us with our marketing activities. We’ll only disclose the
            information necessary for these parties to perform their services
            for us, and they’ll be bound by contractual obligations to protect
          ...
          <li>
            ...
            viewed a video (if the viewer is logged in at the time of viewing)
            or how many times a video was viewed.
          </li>
          <li>
            <em>Administrators: </em>If you join a Workspace owned by another
          ...
          <li>
            <em>For Legal Reasons</em>: We may release your information if we
            believe it is necessary to comply with the law, regulation, valid
            legal process, an enforceable government request, to prevent fraud
            or a security breach, enforce our policies or agreements, or protect
            our or others’ rights, property, or safety.
          </li>
          <li>
            <em>With Your Consent: </em>We’ll otherwise share your information
            only with your consent. For example, if you choose to enable a
            third-party integration, we may share account information and/or
            content from your account, but only as authorized by you when you
            enable or use the integration.
          </li>
        </ul>
        <h2 className="my-5 text-lg font-bold">
        ...
        <p className="mb-5">
          We are committed to protecting your information from unauthorized
          access, use, disclosure, and loss. We use industry-standard security
          practices to keep your information secure, such as encryption, access
          controls, physical security measures, and internal reviews of data
          collection, use, and storage. We’ve also obtained various compliance
          certifications and undergo ongoing audits to ensure continued security
          and compliance best practices.{" "}
        </p>
        <p className="mb-5">
          However, data transmissions over the internet cannot be guaranteed to
          be 100% secure or safe from intrusion by others. Be sure to use secure
          internet connections, protect your login credentials, and create
        ...
        <p className="mb-5">
          ...
          we may receive or collect from you, we’ll retain that information for
          only as long as is necessary for the purposes described in this
          Privacy Policy.
        </p>
        <h2 className="my-5 text-lg font-bold">Data Transfers</h2>
        <p className="mb-5">
          To provide our Services, we transmit, process, and store data in the
          United States and other locations around the world. For example, if
          you access our Services from a foreign country, data may be stored
          locally on the device you use to access the Services.{" "}
        </p>
        <p className="mb-5">
          We perform data transfers in accordance with applicable data
          protection law, using the following safeguards:
        </p>
        <ul>
          <li>
            <em>Standard Contractual Clauses: </em>Where required, we use
            standard contractual clauses to meet the data transfer requirements
            for processing personal data that is subject to the data protection
          ...
          <li>
            <em>Other Valid Transfers: </em>We will otherwise only transfer
            personal data pursuant to a legally valid personal data transfer
            mechanism, including to a country that the European Commission or UK
            authorities have determined provides an adequate level of protection
            for personal data.
          </li>
          <li>
        ...
        <h2 className="my-5 text-lg font-bold">Your Rights</h2>
        <p className="mb-5">
          Individuals in the European Economic Area, the United Kingdom, and
        ...
        <ul>
          <li>
            Our legitimate interests (for example, to send you information about
            new features or upcoming product launches). You have the right to
            object to our use of your personal data for direct marketing at any
            time.
          </li>
          <li>
            As needed to comply with our contractual obligations (for example,
            if you sign up for a contest or promotion, we’ll process your
            personal data as needed for us to perform our obligations under the
            contest or promotion terms).
          </li>
          <li>
            To comply with legal obligations (for example, to respond to a law
            enforcement request or enforce or defend our legal rights).
          </li>
          <li>
            With your consent (for example, if you opt into receiving email
            marketing from us). You have the right to withdraw your consent at
            any time.
          </li>
        </ul>
        <p className="mb-5">
        ...
        <p className="mb-5">
          ...
          afforded to them under California law.
        </p>
        <p className="mb-5">
        ...
        <p className="mb-5">
          In addition to the information provided above in the “Information We
          Collect” section, we collect the following categories of personal
          information from you, your employer, data analytics providers, data
          brokers, and third-party services:
        </p>
        <ul>
          <li>Identifiers (such as name, email address, and profile data);</li>
          <li>
            Commercial information (such as transaction data for a paid
            account);
          </li>
          <li>
          ...
          <li>
            Internet or other network or device activity (such as IP address and
            usage information);
          </li>
          <li>
            Location information (e.g., the general location where you use your
            device when interacting with the Site, Software, and/or Services);
          </li>
          <li>
            Sensory information (such as video recordings if you record a video
            with our service);
          </li>
          <li>
        ...
        <p className="mb-5">
          ...
          information we collect from and about you consistent with the various
          business and commercial purposes we discuss throughout this Privacy
          Policy. We explain the business or commercial purposes for collecting
          personal information above under “How We Use Your Information.”
        </p>
        <p className="mb-5">
          We may also use the categories of personal information for compliance
          with applicable laws and regulations, and we may aggregate the
          information we collect or de-identify the information to limit or
          prevent identification of any particular user or device.
        </p>
        <p className="mb-5"></p>
        <p className="mb-5">
        ...
        <p className="mb-5">
          We do not sell or share the personal information of known consumers
          under 16 years of age.
        </p>
        <p className="mb-5"></p>
        <p className="mb-5">Your California Privacy Rights</p>
        <ul>
          <li>
            Right to Access. You have the right to request, up to two times each
            year, access to categories and specific pieces of personal
            information about you that we collect, use, disclose, sell, and
            share, such information to be provided to you in a readily useable
            format.
          </li>
          <li>
            Right to Delete. You have the right to request that we delete
            personal information that we collect from you, subject to applicable
            legal exceptions.
          </li>
          <li>
            Right to Correct. You have the right to request that we correct
            inaccurate personal information that we maintain about you, subject
            to applicable legal exceptions.
          </li>
          <li>
            Right to Opt-Out of Sale or Sharing of Personal Information. You
            have the right to opt-out of the “sale” or “sharing” of your
            personal information as such terms are defined under California law.
          </li>
          <li>
            Right to Non-Discrimination. You have the right not to be treated in
            a discriminatory manner for exercising your privacy rights. We do
            not use the fact that you have exercised or requested to exercise
            any rights for any purpose other than facilitating a response to
            your request.
          </li>
        </ul>
        <p className="mb-5"></p>
        ...
        <p className="mb-5">
          Please see the Privacy Notice for a description of the personal data
          we collect, the purposes for which we use it, and how and with whom we
          share it.
        </p>
        <p className="mb-5"></p>
        <h2 className="my-5 text-lg font-bold">For Virginia Residents</h2>
        <p className="mb-5">
          This section provides supplemental information to residents of the
          State of Virginia, whose personal data we process in connection with
          the Services.
        </p>
        <p className="mb-5"></p>
        <p className="mb-5">
          For information on the categories of personal data we process, please
          see “Information We Collect” above. The purposes for which we process
          personal data are described in “How We Use Your Information.” For
          information on how we share the categories of personal data we
          collect, please see “How We Share Your Information.”
        </p>
        <p className="mb-5"></p>
        <p className="mb-5">Your Virginia Privacy Rights</p>
        <ul>
          <li>
            Right to Access. You have the right to confirm whether we are
            processing your personal data and to access such personal data.
          </li>
          <li>
            Right to Delete. You have the right to delete personal data provided
            by or obtained by you.
          </li>
          <li>
            Right to Opt-Out. You have the right to opt-out of “targeted
            advertising” as defined under Virginia law. We do not sell personal
            data as “sale” is defined under Virginia law.
          </li>
          <li>
            Right to Correct. You have the right to correct inaccuracies in the
            personal data, taking into account the nature of the personal data
            and the purposes of the processing.
          </li>
          <li>
            Right to Portability. You have the right to obtain a portable copy
            of the personal data that you provided to us.
          </li>
        </ul>
        <p className="mb-5"></p>
        <p className="mb-5">
        ...
        <p className="mb-5">
          We may update this Privacy Policy by posting the updates to our
          website. If an update materially impacts your rights or how we use
