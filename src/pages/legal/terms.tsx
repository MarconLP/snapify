    ...
    <Legal name="Terms of Service">
      <div className="px-8 pt-[100px] lg:px-0">
        ...
        <p className="mb-5">
          ...
          creates a new Workspace on behalf of an organization (such as the
          user’s employer), the organization is the Customer. Customers can
          invite Authorized Users to their Workspace and must designate at least
          one Authorized User to be an Administrator, who will manage and
          control the Workspace. If a user joins an existing Workspace created
          by another person or organization, that person or organization is the
          Customer and the user is an Authorized User. All Customers,
          Administrators, and Authorized Users must comply with these Terms.
        </p>
        <p className="mb-5">
          <strong>1.2 Access. </strong>During the Subscription Term, Customer
          may access and use, and may allow Authorized Users to access and use
        ...
        <p className="mb-5">
          ...
          update automatically. To the extent a component of the Software
          contains any open source software, the open source license for that
          software will govern with respect to that component.
        </p>
        <p className="mb-5">
          <strong>1.4 Restrictions. </strong>Customer will not and will ensure
          Authorized Users do not: (a) reproduce, modify, adapt, or create
          derivative works of the Services; (b) rent, lease, distribute, sell,
          transfer, or sublicense the Services to a third party except as
          permitted in these Terms; (c) interfere with, disrupt, or circumvent
          any security measures or mechanisms designed to protect the Services;
          (d) reverse engineer, disassemble, decompile, or seek to obtain or
          derive the source code, underlying ideas, algorithms, file formats, or
          non-public APIs of Services; (e) remove or obscure any proprietary or
          other notices contained in the Services; (f) harass, threaten, spam or
          cause distress, unwanted attention, or discomfort to a person or
          entity; (g) impersonate or falsely state or misrepresent an
          affiliation with anyone; (h) use the Services to transmit any viruses,
          worms, trojan horses, or other harmful or malicious code or programs;
          (i) use the Services to build competitive products; or (j) misuse the
        ...
        <h2 className="my-5 text-lg font-bold">2. Customer Responsibilities</h2>
        <p className="mb-5">
          <strong>2.1 Authorized Users. </strong>Customer is responsible for
          Authorized Users’ use of the Services and their compliance with these
          Terms. Customer will ensure that all Authorized Users are over the age
          of 13 or the applicable age of digital consent, whichever is older.
          Customer represents that it has obtained all consents necessary for
          Customer and its Authorized Users’ use of the Services, including
          Customer’s ability to convert accounts previously registered by
          individuals using Customer’s business email domain into Authorized
          User accounts.
        </p>
        <p className="mb-5">
        ...
        <p className="mb-5">
          ...
          legally valid data transfer mechanism for the transfer or onward
          transfer, in accordance with all applicable privacy and data
          protection laws.
        </p>
        <p className="mb-5">
          ...
          in any way; (c) contains pornography or sexually explicit material;
          (d) is harmful to minors; or (e) promotes or provides instructional
          information about illegal activities or promotes physical harm or
          injury to any group or individual.
        </p>
        ...
        <p className="mb-5">
          ...
          maintaining the security and confidentiality of Administrator and
          Authorized User accounts, including account credentials such as
        ...
        <p className="mb-5">
          ...
          will govern any subprocessing of personal data.
        </p>
        <h2 className="my-5 text-lg font-bold">4. Payment</h2>
        <p className="mb-5">
          <strong>4.1 Fees. </strong>Customer agrees to pay the Fees in
          accordance with the payment terms set forth on the Order. Customer is
          responsible for paying applicable Taxes.
        </p>
        <p className="mb-5">
        ...
        <p className="mb-5">
          ...
          Confidential Information to anyone except to its affiliates,
          employees, agents, or contractors who need to know it and who are
          bound by confidentiality obligations at least as protective of
          Confidential Information as those described in this section. The
          recipient will be responsible for those parties’ breach of this
          section. A breach of this section may cause irreparable harm and
          entitle the disclosing party to injunctive relief.
        </p>
        <p className="mb-5">
          <strong>5.3 Required Disclosure.</strong> The recipient may disclose
          Confidential Information to the extent required by law, provided that
          the recipient uses reasonable efforts to notify the disclosing party
          in advance and gives them an opportunity to contest the disclosure
          (except as described in Section 8). Confidential Information disclosed
          pursuant to this section will otherwise still be subject to the
        ...
        <p className="mb-5">
          ...
          Customer represents and warrants that it has secured all necessary
          licenses to provide the foregoing license.
        </p>
        <p className="mb-5">
        ...
        <p className="mb-5">
          <strong>7.1 Term.</strong> These Terms will continue in effect until
          terminated as described below.
        </p>
        <p className="mb-5">
          <strong>7.2 Termination for Convenience. </strong>Customer may
          terminate these Terms at any time by deleting Customer’s account,
          including all associated Administrator and Authorized User accounts.
        </p>
        <p className="mb-5">
          <strong>7.3 Termination for Breach. </strong>Either party may
          terminate these Terms for material breach if the other party fails to
        ...
        <p className="mb-5">
          <strong>7.6 Survival. </strong>Terms that are intended by their nature
          to survive termination will survive, including confidentiality
          obligations, limitations of liability, and disclaimers.
        </p>
        ...
        <p className="mb-5">
          ...
          ELECTRONIC COMMUNICATIONS, INCLUDING INTERNET CONGESTION, VIRUS
          ATTACKS, AND DENIAL OF SERVICE ATTACKS.
        </p>
        <p className="mb-5">
          <strong>9.3 Beta Services. </strong>Customer may choose to use Beta
          Services in its sole discretion. Notwithstanding anything to the
        ...
        <p className="mb-5">
          <strong>10.4 Procedures. </strong>The party seeking indemnification
          will promptly notify the other party of the claim and cooperate with
          the other party in defending the claim. The indemnifying party will
          have full control and authority over the defense, except that: (a) any
          settlement that does not include a complete release of the indemnified
          party from all liability or that imposes any admission, obligation, or
          restriction on the indemnified party requires prior written consent,
          not to be unreasonably withheld or delayed and (b) the indemnified
          party may join in the defense with its own counsel at its own expense.
          The indemnities above are Customer’s only remedy for infringement of
          third-party intellectual property rights.
        </p>
        <h2 className="my-5 text-lg font-bold">11. Limitation of Liability</h2>
        <p className="mb-5">
          <strong>11.1 Indirect Damages.</strong> EXCEPT FOR LIABILITY ARISING
          FROM A PARTY’S GROSS NEGLIGENCE, WILLFUL MISCONDUCT, OR BREACH OF
          SECTIONS 1.4 OR 2.4, NEITHER PARTY WILL HAVE ANY LIABILITY ARISING OUT
          OF OR RELATED TO THESE TERMS, WHETHER IN CONTRACT OR TORT OR UNDER ANY
          OTHER THEORY OF LIABILITY, FOR ANY LOSS OF USE, LOST PROFITS,
          INTERRUPTION, OR LOSS OF BUSINESS OR DATA OR ANY INDIRECT, SPECIAL,
          INCIDENTAL, PUNITIVE, RELIANCE OR CONSEQUENTIAL DAMAGES OF ANY KIND,
          HOWEVER CAUSED AND WHETHER OR NOT THE PARTY HAS BEEN ADVISED OF THE
        ...
        <p className="mb-5">
          THIS SECTION WILL NOT APPLY TO THE EXTENT PROHIBITED BY APPLICABLE
          LAW.
        </p>
        <h2 className="my-5 text-lg font-bold">
        ...
        <p className="mb-5">
          <strong>12.3 Mandatory Arbitration.</strong> Any claims or disputes
          relating to these Terms or the Services must be resolved through final
        ...
        <h2 className="my-5 text-lg font-bold">13. Miscellaneous</h2>
        <p className="mb-5">
          <strong>13.1 Entire Agreement. </strong>These Terms supersede any
          prior agreements or understandings between the parties and constitutes
          the entire agreement between the parties related to access and use of
          the Services. The terms of the Order will control over these Terms to
        ...
        <p className="mb-5">
          <strong>13.7 Governing Law. </strong>These terms will be governed by
        ...
        <p className="mb-5">
          <strong>13.9 Relationship of the Parties. </strong>The parties are
        ...
        <p className="mb-5">
          <strong>13.10 Export Controls.</strong> Customer agrees to comply with
          all relevant U.S. and foreign export and import laws in using the
          Services. Customer represents and warrants that neither it nor its
          Authorized Users are listed on any U.S. government list of prohibited
          or sanctioned parties or located in or a national of a country that is
          subject to U.S. government embargo.
        </p>
        <p className="mb-5">
          <strong>13.11 U.S. Government Restricted Rights.</strong> The Services
          are “commercial items,” “commercial computer software” and “commercial
          computer software documentation,” pursuant to DFAR section 227.7202
          and FAR section 12.212, as applicable. All the Services are and were
          developed solely at private expense. To the extent permitted in these
          Terms, any use, modification, reproduction, release, performance,
          display, or disclosure of the Services by the U.S. Government will be
          governed solely by these Terms.
        </p>
        <p className="mb-5">
          <strong>13.12 Third-Party Beneficiaries.</strong> There are no
          third-party beneficiaries to these Terms.
        </p>
        <h2 className="my-5 text-lg font-bold">14. Definitions</h2>
        <p className="mb-5">
          “Administrator” means an Authorized User designated by Customer to
          manage and control Customer’s and Authorized Users’ accounts.
        </p>
        <p className="mb-5">
          “Authorized User(s)” means Customer’s employees, agents, or other
          third parties authorized by Customer to access or use the Services.
        </p>
        <p className="mb-5">
          “Beta Service” means early access trials or releases of new features
          or services identified as “alpha,” “beta,” “preview,” “early access,”
          “evaluation,” or other words or phrases with similar meanings.
        </p>
        <p className="mb-5">
          “Confidential Information” means information exchanged by the parties
          that would reasonably be understood to be confidential given the
          nature of the information and manner of disclosure, including
          business, product, technology, and marketing information, Orders,
          discounts, non-public payment terms, audit reports, and Customer Data.
          Confidential Information does not include information that (a) is or
          becomes publicly known through lawful means; (b) was known to the
          recipient prior to disclosure without confidentiality obligations; (c)
          is received from a third party without breach of confidentiality
          obligations; or (d) was independently developed by the recipient
          without use of or access to any Confidential Information.
        </p>
        <p className="mb-5">
          “Customer” means the individual or organization agreeing to these
          Terms, as described in Section 1.1.
        </p>
        <p className="mb-5">
        ...
        <p className="mb-5">
          “Documentation” means any documentation or materials provided to
        ...
        <p className="mb-5">
          “Fees” means the fees for the Services displayed on the Order, plus
          any applicable Taxes.
        </p>
        <p className="mb-5">
          “Legal Process” means an information disclosure or access request made
          under law, governmental regulation, court order, subpoena, warrant,
          governmental regulatory or agency request, or other legal authority,
          legal procedure, or similar valid process.
        </p>
        <p className="mb-5">
        ...
        <p className="mb-5">
          “Subscription Term” means the applicable initial or renewal term for
          Customer’s provision of the Services identified in an Order.
        </p>
        <p className="mb-5">
